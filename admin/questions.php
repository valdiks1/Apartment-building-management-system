	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			  <div class="navbar-nav">
			    ...
			    <a href="mainInfo.php" class="nav-link">Приветствие</a>
			    <a href="applications.php" class="nav-link">Заявки</a>
			    <a class="nav-link active" href="questions.php">Вопросы</a>
			    <form method="post" action="">
					<input class="btn btn-outline-light" type="submit" name="logoutAdmin" value="Выйти">
				</form> 
			  </div>
			</div>
		</nav>
